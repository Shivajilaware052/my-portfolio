const projectEffect = () => {
    ...
    window.addEventListener('scroll', () => {
        ...
        if (scrollPosition > sectionTop && scrollPosition < sectionBottom) {
            ...
            document.querySelector('.project-4').style = "transform: translateX(0%); opacity: 1"
            document.querySelector('.tech-stack-4').style = "transform: translateY(0%); opacity: 1"
        } else {
            ...
            document.querySelector('.project-4').style = "transform: translateX(100%); opacity: 0"
            document.querySelector('.tech-stack-4').style = "transform: translateX(-100%); opacity: 0"
        }
    })
}
